        ...
        <div className="container-fluid">
          ...
          <div className="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <ul className="navbar-nav me-auto mb-2 mb-lg-0">
              ...
              <li className="nav-item">
                <Link to={"/view-bookings"} className="nav-link">Pay my Bill</Link>

              </li>
              <li className="nav-item">
                <Link to={"/staff"} className="nav-link">Orders</Link>

              </li>
              <li className="nav-item">
                <Link to={"/"} className="nav-link">Customer Services</Link>

              </li>
              <li className="nav-item">
                <Link to={"/about-us"} className="nav-link">Schedule Date</Link>
